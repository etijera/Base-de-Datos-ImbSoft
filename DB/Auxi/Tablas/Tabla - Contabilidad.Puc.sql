...
GO
EXEC sys.sp_addextendedproperty @name=N'MS_Description', @value=N'Tipo concepto' , @level0type=N'SCHEMA',@level0name=N'Contabilidad', @level1type=N'TABLE',@level1name=N'Puc', @level2type=N'COLUMN',@level2name=N'TipoConcepto'
GO
EXEC sys.sp_addextendedproperty @name=N'MS_Description', @value=N'Gravamen' , @level0type=N'SCHEMA',@level0name=N'Contabilidad', @level1type=N'TABLE',@level1name=N'Puc', @level2type=N'COLUMN',@level2name=N'Gravamen'
GO
EXEC sys.sp_addextendedproperty @name=N'MS_Description', @value=N'Valor Inicial Banco' , @level0type=N'SCHEMA',@level0name=N'Contabilidad', @level1type=N'TABLE',@level1name=N'Puc', @level2type=N'COLUMN',@level2name=N'InicialBanco'
GO
EXEC sys.sp_addextendedproperty @name=N'MS_Description', @value=N'Numero Banco' , @level0type=N'SCHEMA',@level0name=N'Contabilidad', @level1type=N'TABLE',@level1name=N'Puc', @level2type=N'COLUMN',@level2name=N'BancoNumero'
GO
EXEC sys.sp_addextendedproperty @name=N'MS_Description', @value=N'Tipo Banco' , @level0type=N'SCHEMA',@level0name=N'Contabilidad', @level1type=N'TABLE',@level1name=N'Puc', @level2type=N'COLUMN',@level2name=N'BancoTipo'
GO
...
GO
EXEC sys.sp_addextendedproperty @name=N'MS_Description', @value=N'Fecha' , @level0type=N'SCHEMA',@level0name=N'Contabilidad', @level1type=N'TABLE',@level1name=N'Puc', @level2type=N'COLUMN',@level2name=N'Fecha'
GO
